...
type Content struct {
	...
	CheckpointId  string                 `protobuf:"bytes,1,opt,name=checkpoint_id,json=checkpointId,proto3" json:"checkpoint_id,omitempty"` // Optional: Checkpoint ID for this content
	Role          string                 `protobuf:"bytes,2,opt,name=role,proto3" json:"role,omitempty"`                                     // The role of the content (e.g., "user", "assistant", "system")
	Type          string                 `protobuf:"bytes,3,opt,name=type,proto3" json:"type,omitempty"`                                     // The type of content (e.g., "text", "image")
	Mimetype      string                 `protobuf:"bytes,4,opt,name=mimetype,proto3" json:"mimetype,omitempty"`                             // MIME type of the data (e.g., "text/plain", "image/png")
	Data          string                 `protobuf:"bytes,5,opt,name=data,proto3" json:"data,omitempty"`                                     // The actual content data
...
const file_proto_gar_proto_rawDesc = "" +
	...
	"\x0fSTATE_COMPLETED\x10\x032\x83\x01\n" +
	"\fAgentService\x12-\n" +
